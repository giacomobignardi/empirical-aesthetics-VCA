...
#Date: 2023-05-02
#Function to calculate Variance Components from an MLM
...
#if CI are True (default) we recommend using both bootMer and VCA_exposure_tidyCI to interpret the output
